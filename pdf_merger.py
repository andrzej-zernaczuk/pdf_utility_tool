...
def open_merger_window(merger_window: tk.Frame) -> None:
    ...
    move_up_button = tk.Button(
        move_buttons_frame,
        text="Move up",
        command=lambda: move_selected_pdfs_up(listbox),
    )
    ...
    move_down_button = tk.Button(
        move_buttons_frame,
        text="Move down",
        command=lambda: move_selected_pdfs_down(listbox),
    )
    ...
    remove_button = tk.Button(
        merger_window,
        text="Remove selected PDF files",
    ...
    remove_all_button = tk.Button(
        merger_window,
        text="Remove all PDF files",
        command=on_remove_all,
    )
